...
public class RecordCreationTests {
    ...
    @Test
    public void RecordCreationTests() {

        gotoNewRecordPage();
        fillRecordform(new RecordData("Ivan", "Petrov", "Somewhere", "+19012345678", "ipetrov@gmail.com"));
    ...
    private void fillRecordform(RecordData recordData) {
        ...
        wd.findElement(By.name("mobile")).sendKeys(recordData.getPhone());
        wd.findElement(By.name("email")).click();
        wd.findElement(By.name("email")).clear();
        wd.findElement(By.name("email")).sendKeys(recordData.getEmail());
    }

    private void gotoNewRecordPage() {
